...
pc_save_dir = 'gitignore_stuff/pcls'
...
def sample_grasps(filename,path,name,scale,path_grasps,path_pcs):
    ...
    # sample point clouds
    pcs,depths = graspsampler.get_multiple_random_pcs(number_of_pcs=NUM_PCS, 
                                            target_pc_size=TARGET_PC_SIZE, 
                                            depth_noise=[4000,1/4000], 
                                            dropout=0.3)
...
sample_grasps(obj,path,name=obj,scale=1,path_grasps=None,path_pcs="./")
