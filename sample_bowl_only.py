...
NUM_LOCAL_GRASPS = 0
NUM_FAR_GRASPS = 10
>>>>>>> 3d96b7d17e0044bf892fcd8024cd80ebdfe4dd5d
=======
trial = 2
category = 'bowl'
# i=0
...
NUM_FAR_GRASPS = 1000
>>>>>>> c77a29427bd49ffc433e326ad8b625024aa73204
...
def process(i):
    ...
    if i == 5 or i == 3:
        _, normals, transforms, origins, quaternions,\
            alpha, beta, gamma, _, is_promising = graspsampler.sample_grasps_mug(number_of_grasps=NUM_GRASPS,
                                                                        alpha_lim = [np.pi/2, np.pi/2],
                                                                        beta_lim = [0,0],
                                                                        gamma_lim = [0, 0],
                                                                        silent=True,jcups=True
                                                                        )
       
    else:
        _, normals, transforms, origins, quaternions,\
            alpha, beta, gamma, _, is_promising = graspsampler.sample_grasps_bowl(number_of_grasps=NUM_GRASPS,
                                                                        alpha_lim = [np.pi/2, np.pi/2],
                                                                        beta_lim = [0,0],
                                                                        gamma_lim = [0, 0],
                                                                        silent=True)
