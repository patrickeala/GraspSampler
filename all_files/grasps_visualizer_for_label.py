...
def label_obj(idx):
    ...
    for idx in range(num_obj):
        ...
        grasp_filename = f"semantic_dataset/{obj_class}/{obj_name}/downsampled_grasps.npz"
        ...
        for i in range(min(translations.shape[0],1000)):
            scene = Scene()
            ...
            save_grasp_images(i,scene,obj_class,idx)
