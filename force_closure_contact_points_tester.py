...
data_path = f"/home/user/isaac/grasps_sampled_for_positive_grasps/{cat}/{cat}{idx:03}_isaac_lower_friction"
...
#         try:
#             get_force_closure_labels_object(cat,idx,trial)
#         except:
#             continue
...
for grasp_idx in range(100):
    print("num_intersection_rays",num_intersection_rays[grasp_idx])
    sampler.grasp_visualize(grasp_transforms[grasp_idx],grasp_debug_items=True)
