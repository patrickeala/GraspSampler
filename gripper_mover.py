...
cat = "mug"
idx = 12
obj_filename = "/home/gpupc2/GRASP/grasper/assets/meshes_10_objects/048_hammer/google_64k/textured.obj"
...
init_translation = np.array([0,1.0,0.0])
rot_vec = init_translation
init_orientation = R.from_rotvec(rot_vec).as_euler('XYZ',degrees=True)
